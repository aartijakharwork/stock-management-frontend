...
import { LayoutDashboard, ShoppingCart, Package, Users, FileText, Settings, BookOpen } from 'lucide-react';
...
const NAV_ITEMS: NavItemDef[] = [
  ...
  { to: '/shop/catalogue', icon: BookOpen,        label: 'Catalogue', module: 'catalogue', end: false },
